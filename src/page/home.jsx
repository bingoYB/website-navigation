      ...
      case 13:
        ...
        if (type === "local") {
          ...
          if (type != "txt" && searchRst[type].length) {
            ...
            var url =
              currentEngine.searchUrl + document.getElementById("search").value;
          }
        }
        ...
        <div style={{ overflow: "hidden" }}>
          <div className="search-pre">
            <div
              ...
              style={{ background: `url(${currentEngine.icon})` }}
              title="切换搜索引擎"
          ...
          <div className="search-input">
            <input
              ...
              onInput={util.debounce(search, 500)}
              onCompositionStart={() => {
                pinyingInput = true;
              }}
              onCompositionEnd={() => {
          ...
          <ul>
            ...
            {searchRst.engine.map((el, i) => (
              <li
                ...
                onClick={() => {
                  console.log(1231230);
                  window.open(currentEngine.searchUrl + el.Txt, "_blank");
                }}
              >
                <div className="result-icon">
                  <i
